...
| Продуктовая память + product-onboard | 2.3.0 | 1.7.0 — ветка `feat/product-onboard-1.7`, [PR #3](https://github.com/toiiia/qtim-agent-team/pull/3) | актуализация закрытого PR #2 поверх 1.6.0 (канон `decisions.md`, новые редакции setup 4.1/4.6/Phase 5); ждёт ревью владельца |
